...
const offers: Offer[] = [
  { 
    ...
    description: "You claimed a free coffee with your main dish order. Hope you enjoyed it!",
    cooldown: true,
    image: {
      src: "/super-sale.jpg",
  ...
  <div class="flex items-center justify-between w-full mt-1">
    ...
    <Badge variant="secondary" class=" px-2 py-1 rounded-md">
      ...
      <CardFooter class="mt-3">
        ...
        <!-- Action Buttons -->
        <div v-else-if="offer.showActions" class="flex w-full justify-between">

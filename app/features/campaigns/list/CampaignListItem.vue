          ...
          <div class="grid grid-cols-3 gap-3">
            ...
            >
              ...
              <div class="flex flex-col leading-tight">
                <span class="text-lg font-semibold text-foreground">2.3k</span>
                <span
            ...
            >
              ...
              <div class="flex flex-col leading-tight">
                <span class="text-lg font-semibold text-foreground">98</span>
                <span
                  class="text-[11px] font-medium text-muted-foreground uppercase tracking-wide"
                  >Views</span
                >
            ...
            >
              ...
              <div class="flex flex-col leading-tight">
                <span class="text-lg font-semibold text-foreground">12%</span>
                <span
                  class="text-[11px] font-medium text-muted-foreground uppercase tracking-wide"
                  >Rate</span
                >
